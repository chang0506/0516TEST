package com.example.korea_sleepTech_test_0516.config;

import com.example.korea_sleepTech_test_0516.filter.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers(HttpMethod.GET, ("/api/posts/**")).permitAll()// : 인증 처리 없이 접근 가능 (누구나 접근 가능 - 인증, 인가 없이 접근 가능)
